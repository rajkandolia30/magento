...
$table = $installer->getConnection()
    ...
    ->addIndex($installer->getIdxName('seller/eav_attribute', array('used_for_sort_by')),
        array('used_for_sort_by'))
    ->addIndex($installer->getIdxName('seller/eav_attribute', array('used_in_product_listing')),
        array('used_in_product_listing'))
    ->addForeignKey($installer->getFkName('seller/eav_attribute', 'attribute_id', 'eav/attribute', 'attribute_id'),
...
$setup->addAttribute('seller', 'firstname', array(
    'group'                      => 'General',
    'input'                      => 'text',
    'type'                       => 'varchar',
    'label'                      => 'firstname',
...
$setup->addAttribute('seller', 'lastname', array(
    'group'                      => 'General',
    'input'                      => 'text',
    'type'                       => 'varchar',
    'label'                      => 'lastname',
...
$setup->addAttribute('seller', 'email', array(
    'group'                      => 'General',
    'input'                      => 'text',
    'type'                       => 'varchar',
    'label'                      => 'email',
...
$setup->addAttribute('seller', 'phoneNo', array(
    'group'                      => 'General',
    'input'                      => 'text',
    'type'                       => 'int',
    'label'                      => 'phoneNo',
