...
class Ccc_Seller_Block_Adminhtml_Seller_Attribute_Set_Main extends Mage_Adminhtml_Block_Template{
    ...
    protected function _prepareLayout(){
        ...
        $this->setChild('save_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')->setData(array(
                'label'     => 'Save Attribute Set',
                'onclick'   => 'editSet.save();',
                'class'     => 'save'
        )));
        $deleteConfirmMessage = $this->jsQuoteEscape('All products of this set will be deleted! Are you sure you want to delete this attribute set?');
        $deleteUrl = $this->getUrl('*/*/delete', array('id' => $setId));
        $this->setChild('delete_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')->setData(array(
                'label'     => 'Delete Attribute Set',
